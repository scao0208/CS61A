...
def roll_dice(num_rolls, dice=six_sided):
    ...
    """
    """ Cases are in the tests folder - 01.py
    """
    ...
    for i in range(num_rolls):
        num_dice.append(dice())
            
    for value in num_dice:
        if value == 1:
            sum_dice = 1
            break
        else:
...
# print(roll_dice(4, dice))

# print(roll_dice(3, dice))
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_score > 100:
        ten_dig_opp = opponent_score // 10 % 10
    else:
        ten_dig_opp = opponent_score // 10
        
    one_dig_self = player_score % 10
    curr_score = 0 
    if abs(ten_dig_opp - one_dig_self) == 0:
        curr_score = 1
    else:
        curr_score = 3 * abs(ten_dig_opp - one_dig_self)
    return curr_score
    # END PROBLEM 2

# print(boar_brawl(52, 79))
# print(boar_brawl(0, 5))
...
# print(take_turn(2, 7, 27, make_test_dice(4, 5, 1)))

# print(take_turn(0, 37, 15))
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if num_factors(score) in range(3, 5):
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(goal):
        for opp_score in range(goal):
            curr_score = strategy(score, opp_score)
            if curr_score != diff:
                return False
    return True
    # END PROBLEM 7
...
def make_averaged(original_function, samples_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def result_return(*args):
        sum_dice = 0
        for i in range(samples_count):
            x = original_function(*args)
            sum_dice += x 
        return sum_dice / samples_count
    # when a function returns a function, it can pass the second_order parameters!!!
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    num = 1
    max_num = 1
    max_avg = make_averaged(roll_dice, samples_count)(1, dice)
    while num < 10:
        num += 1
        num_avg = make_averaged(roll_dice, samples_count)(num, dice)
        if num_avg > max_avg:
            max_num = num
            max_avg = num_avg
    return max_num
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    diff = boar_brawl(score, opponent_score)
    if diff >= threshold:
        return 0
    else:
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    num_roll = 0
    total_score = sus_update(num_roll, score, opponent_score)
    if total_score - score >= threshold:
        return 0
    else:
        return num_rolls 
