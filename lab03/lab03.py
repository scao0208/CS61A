...
def get_k_run_starter(n, k):
    ...
    while i <= k:
        ...
        # while n % 10 > n // 10 % 10: lose the n > 10 condition causes error of k > runs in n
            n = n // 10  
        final = n % 10
        i += 1
        n = n // 10 
...
def nearest_two(x):
    ...
    if x < 1:
        ...
        factor = 2
    while abs(power_of_two - x) > abs(power_of_two * factor- x):
        power_of_two = factor * power_of_two
