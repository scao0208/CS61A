...
def funception(func1, begin): ### important!!
...
def mod_maker():
    ...
    True
    """
    return lambda x, y: x % y or True # for 0, false, none can be seen as the false, so we can use and, or statement to solve the problem
